This notebook finetunes T5 on **2% of the CNN/DailyMail dataset** due to Colab compute limits.
...
This notebook focuses on **learning the finetuning pipeline,** not producing a production-ready model.
